  ...
  const generateMockCommunities = (): any[] => {
    const base = [
      ...
      },
      {
        ...
        description:
          'Low level systems programming, memory safety guarantees, WebAssembly, actix-web, and embedded systems in Rust.',
        members: 510,
        isPrivate: true,
      ...
      },
      {
        ...
        description:
          'Figma auto-layout, interactive components, variable design tokens, and developer handoff best practices.',
        members: 920,
        isPrivate: false,
      ...
      },
      {
        ...
        description:
          'Neural networks, prompt engineering, fine-tuning LLMs, PyTorch tutorials, and local model inference architectures.',
        members: 4200,
        isPrivate: false,
      ...
      },
      {
        ...
        description:
          'Ethical hacking, OWASP Top 10 vulnerabilities, zero trust architecture, and network packet analysis scripts.',
        members: 780,
        isPrivate: true,
      ...
      },
      {
        ...
        description:
          'GraphQL schema design, Apollo Federation, query caching, resolver optimization, and code-generation tools.',
        members: 460,
        isPrivate: false,
    ...
    const topics = [
      {
        ...
        desc: 'Modern Android development, coroutines, Ktor backend integration, and Multiplatform UI.',
        isPrivate: false,
        tag: 'Kotlin',
      },
      {
        name: 'SwiftUI Architects',
        desc: 'Declarative layout hierarchies, state management with Observable, custom animations, and layout wrappers.',
        isPrivate: false,
        tag: 'SwiftUI',
      },
      {
        name: 'DevOps & GitOps',
        desc: 'Kubernetes operators, Terraform provisioning, GitHub Actions pipelines, and Prometheus monitoring.',
        isPrivate: true,
        tag: 'DevOps',
      },
      {
        name: 'Ethereum Builders',
        desc: 'Solidity smart contracts, Hardhat compiling, Ethers.js frontend integration, and gas cost optimizations.',
        isPrivate: false,
        tag: 'Web3',
      },
      {
        name: 'Creative Coding & WebGL',
        desc: 'Three.js shaders, custom fragment styling, noise animations, and physics engine setups.',
        isPrivate: false,
        tag: 'WebGL',
      },
      {
        name: 'Golang Microservices',
        desc: 'High-concurrency networking patterns, gRPC contract routing, sqlx querying, and Docker deployments.',
        isPrivate: true,
        tag: 'Go',
      },
      {
        name: 'Product Growth Circle',
        desc: 'A/B testing methodologies, cohort conversion matrices, user retention graphs, and landing page conversions.',
        isPrivate: false,
        tag: 'Product',
      },
      {
        name: 'Angular Enterprise',
        desc: 'Strict workspace setups, standalone directives, custom injection tokens, and state stores.',
        isPrivate: false,
        tag: 'Angular',
      },
      {
        name: 'Flutter App Craftsmen',
        desc: 'Widget trees rendering optimizations, BloC business logic layouts, package builders, and web builds.',
        isPrivate: false,
        tag: 'Flutter',
      },
      {
        name: 'Svelte Society',
        desc: 'Reactive assignments compilation, SvelteKit routing, server layouts, and component libraries.',
        isPrivate: false,
        tag: 'Svelte',
      },
    ];
    ...
    const contentTemplates = [
      {
        ...
        content:
          "When building for enterprise clients, the most important aspect is error-boundary handling. Make sure you wrap screen segments so that a single failure doesn't crash the entire screen layout. Let me know what you think!",
      },
      {
        title: 'How we optimized render performance by 40%',
        content:
          'We recently replaced standard ScrollView lists with FlashList and implemented React.memo on items. Adding custom keyExtractors and estimatedItemSize resulted in an immediate reduction in frame drops.',
      },
      {
        title: 'Offline-First architecture patterns',
        content:
          'For an app that remains useful in low connectivity, write data to local secure databases like MMKV, fetch query arrays, and sync pending updates to a local queue. Highly recommend standardizing the API envelope.',
      },
      {
        title: 'Discussion: Designing flexible component systems',
        content:
          "Should we rely on strict predefined spacing structures or let components accept flexible margins? Share your team's configuration guidelines!",
      },
    ];

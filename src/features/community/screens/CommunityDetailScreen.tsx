...
export const CommunityDetailScreen = () => {
  ...
  return (
    <View style={[styles.container, {backgroundColor: colors.background}]}>
      {/* Absolute overlay header for premium back button */}
      ...
      <ScrollView
        ...
        <View style={styles.bannerContainer}>
          {community.image ? (
            <Image source={{uri: community.image}} style={styles.bannerImage} resizeMode="cover" />
          ) : (
        ...
        <View style={[styles.profileCard, {backgroundColor: colors.surface, borderColor: colors.border}]}>
          ...
          <View style={styles.profileHeader}>
            <View style={styles.titleWrapper}>
              ...
              <View style={styles.badgeRow}>
                ...
                <View style={[styles.badge, {backgroundColor: colors.surfaceVariant, marginLeft: wp('2%')}]}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}>
            {isActionLoading ? (
              <ActivityIndicator size="small" color={community.isJoined ? colors.text : '#ffffff'} />
            ) : (
          ...
          <View style={styles.descriptionSection}>
            <Text style={[typography.bodyMedium, {color: colors.textSecondary, fontWeight: '700', marginBottom: hp('1%')}]}>
              ABOUT THE COMMUNITY
            </Text>
          ...
          <ScrollView
            ...
            {Array.from({length: 6}).map((_, i) => (
              <View key={i} style={styles.memberAvatarWrapper}>
                ...
                <Text style={[typography.caption, {color: colors.text, marginTop: 4, fontSize: 10}]}>
                  User {i + 1}
                </Text>
              </View>
            ))}
        ...
        {/* Discussion / Posts Section (Partial Loading Setup) */}
          ...
          {isLoadingPosts ? (
            <View style={styles.loadingPostsBox}>
              ...
              <Text
                style={[
                  typography.caption,
                  {color: colors.textSecondary, marginTop: hp('1%')},
                ]}>
                Loading posts...
              </Text>
            </View>
            ...
            <FlatList
              ...
              renderItem={({item}) => (
                <View
                  ...
                  <Text style={[typography.h3, {color: colors.text, fontSize: 15, marginTop: hp('1%'), marginBottom: hp('0.5%')}]}>
                    {item.title}
                  </Text>

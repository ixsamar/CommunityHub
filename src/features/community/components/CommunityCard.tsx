      ...
      <View style={styles.contentRow}>
        {community.image ? (
          <Image
            ...
            style={[styles.image, {backgroundColor: colors.surfaceVariant, borderRadius: borderRadius.md}]}
            resizeMode="cover"
          />
        ) : (
          <View style={[styles.imagePlaceholder, {backgroundColor: colors.surfaceVariant, borderRadius: borderRadius.md}]}>
        ...
        <View style={styles.textContainer}>
          <View style={styles.titleRow}>
            ...
            {community.isPrivate && (
              <View style={[styles.privateBadge, {backgroundColor: colors.surfaceVariant, borderRadius: borderRadius.xs}]}>
          ...
          <View style={styles.footerRow}>
            ...
            {community.isJoined && (
              <View style={[styles.joinedBadge, {backgroundColor: colors.successLight, borderRadius: borderRadius.sm}]}>

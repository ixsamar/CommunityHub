/**
 * CommunityHub Design Token — Color System
 *
 * All colors are defined using HSL for easy theming. Each mode exposes:
 * - Brand palette  (primary, secondary)
 * - Surface hierarchy (background → surface → surfaceVariant → card)
 * - Semantic colors (error, success, warning, info)
 * - Text hierarchy (text, textSecondary, textDisabled)
 * - Accessibility contrast tokens (onPrimary, onSurface)
 * - Shimmer/skeleton tokens for loading states
 */

/**
 * Button — Production-grade accessible button with Reanimated press feedback.
 *
 * Variants: primary | secondary | ghost | danger
 * States:   default, loading (spinner), disabled, pressed (scale micro-animation)
 *
 * Accessibility:
 *   - accessibilityRole="button"
 *   - accessibilityState: disabled, busy
 *   - accessibilityLabel: defaults to title, overridable
 *   - accessibilityHint: optional usage hint for screen readers
 */
  ...
  return (
    <Animated.View style={animatedStyle}>
      <Animated.View
        ...
        testID={testID}
        /* Propagate press events via onStartShouldSetResponder pattern */
